#!/usr/bin/env python3
"""
Test Claude Opus 4.1 on all forms and store results in claude folder.
"""
...
def test_form(form_config):
    ...
    output_path = f"./filled_outputs/claude/claude_opus_{form_name}.pdf"
    ...
    print("="*80)
    print("PROCESSING WITH CLAUDE OPUS 4.1")
    print("="*80 + "\n")
...
def main():
    """Test all forms with Claude Opus."""

    os.makedirs("filled_outputs/claude", exist_ok=True)

    print("\n" + "="*80)
    print("CLAUDE OPUS 4.1 TESTING SUITE")
    print("="*80 + "\n")
    ...
    # Summary
    print("="*80)
    print("SUMMARY: CLAUDE OPUS 4.1 RESULTS")
    print("="*80)
