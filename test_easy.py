#!/usr/bin/env python3
"""Test script for easy-acro.pdf form."""
...
def test_easy_form():
    """Test the simplified PDF form auto-fill system on easy-acro.pdf."""

    # Setup
    form_path = "./sample_forms/easy-acro.pdf"
    output_path = "./filled_outputs/filled_output_easy-acro.pdf"
    form_type = "Simple account application form for individual investors"

    os.makedirs("filled_outputs", exist_ok=True)

    print("="*80)
    print("TESTING OPTIMIZED SYSTEM ON EASY-ACRO.PDF")
    print("="*80)
    print(f"\nForm: {form_path}")
